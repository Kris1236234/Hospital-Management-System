...
namespace Hospital.Web.Areas.Identity.Pages.Account
{
    public class LoginWithRecoveryCodeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("Użytkownik o  ID '{UserId}' zalogowal się za pomocą kodu odzyskiwania.", user.Id);
            ...
            {
                _logger.LogWarning("Nieprawidłowy kod odzyskiwania wprowadzony dla użytkownika z ID '{UserId}' ", user.Id);
