...
namespace Hospital.Services
{
    public interface IHospitalInfo
    {
        ...
        IEnumerable<HospitalInfoViewModel> SearchHospitals(string searchTerm);
        IEnumerable<HospitalInfoViewModel> GetHospitalsByCity(string city);
        IEnumerable<HospitalInfoViewModel> GetHospitalsByType(string type);
    }
}
